          ...
          <div className="glass rounded-2xl p-6 border border-brand-cyan/20 shadow-[0_0_40px_-10px_rgba(6,182,212,0.15)] relative overflow-hidden">
            ...
            {currentSong && (
              <div className="mt-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex items-center gap-2.5 bg-dark/60 border border-dark-border/60 rounded-xl px-4 py-2.5 shrink-0 self-stretch md:self-auto justify-center">
